...
FText UPCGGeometryCollectionSelectBonesSettings::GetDefaultNodeTitle() const
{
	switch (Mode)
	{
	case EPCGGeometryCollectionBoneSelectionMode::All: return LOCTEXT("AllTitle", "Select All Bones");
	case EPCGGeometryCollectionBoneSelectionMode::None: return LOCTEXT("NoneTitle", "Select No Bones");
	case EPCGGeometryCollectionBoneSelectionMode::Root: return LOCTEXT("RootTitle", "Select Root Bones");
	case EPCGGeometryCollectionBoneSelectionMode::Pieces: return LOCTEXT("PiecesTitle", "Select Pieces");
	case EPCGGeometryCollectionBoneSelectionMode::Clusters: return LOCTEXT("ClustersTitle", "Select Clusters");
	case EPCGGeometryCollectionBoneSelectionMode::AtLevel: return LOCTEXT("LevelTitle", "Select Bones At Level");
...
{
	return {
		FPCGPreConfiguredSettingsInfo(PreconfiguredPieces, LOCTEXT("PiecesTitle", "Select Pieces")),
		FPCGPreConfiguredSettingsInfo(PreconfiguredClusters, LOCTEXT("ClustersTitle", "Select Clusters")),
		FPCGPreConfiguredSettingsInfo(PreconfiguredAll, LOCTEXT("AllTitle", "Select All Bones")),
		FPCGPreConfiguredSettingsInfo(PreconfiguredNone, LOCTEXT("NoneTitle", "Select No Bones")),
		FPCGPreConfiguredSettingsInfo(PreconfiguredRoot, LOCTEXT("RootTitle", "Select Root Bones")),
		FPCGPreConfiguredSettingsInfo(PreconfiguredAtLevel, LOCTEXT("LevelTitle", "Select Bones At Level")),
	};
}

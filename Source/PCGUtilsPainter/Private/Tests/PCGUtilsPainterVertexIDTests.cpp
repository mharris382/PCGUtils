...
bool FPCGUtilsPainterVertexIDTest::RunTest(const FString&)
{
	...
	TestEqual(TEXT("Bounds palette title"), GetDefault<UPCGDynMeshPainterFromPointsProviderSettings>()->GetDefaultNodeTitle().ToString(), FString(TEXT("Bounds Brush Painter")));
#endif
	return true;
}
#endif

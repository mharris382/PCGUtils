...
const FName FPCGUtilsEditorStyle::PainterFactoryInputPinIcon(TEXT("PCGUtils.Pin.IN_PainterFactory"));
const FName FPCGUtilsEditorStyle::PainterFactoryOutputPinIcon(TEXT("PCGUtils.Pin.OUT_Painter"));
...
TSharedRef<FSlateStyleSet> FPCGUtilsEditorStyle::Create()
{
	...
	Style->Set(SelectionFactoryOutputPinIcon,
		new FSlateVectorImageBrush(
			...
			FVector2D(22.0f, 22.0f)));
	Style->Set(PainterFactoryInputPinIcon,
		new FSlateVectorImageBrush(
			Style->RootToContentDir(TEXT("Icons/PCGUtils_Pin_IN_PainterFactory"), TEXT(".svg")),
			FVector2D(22.0f, 22.0f)));
	Style->Set(PainterFactoryOutputPinIcon,
		new FSlateVectorImageBrush(
			Style->RootToContentDir(TEXT("Icons/PCGUtils_Pin_OUT_Painter"), TEXT(".svg")),
			FVector2D(22.0f, 22.0f)));
...
#define PCGUTILS_ADD_ACTION_ICON(_NAME, _SIZE) \
	...
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_XYZ, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_XZY, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_YXZ, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_YZX, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_ZXY, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(AxisOrder_ZYX, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_X, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_XY, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_XYZ, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_XZ, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_Y, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_YX, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_YZ, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_Z, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_ZX, AIS_Wide)
	PCGUTILS_ADD_ACTION_ICON(RotOrder_ZY, AIS_Wide)
	// EPCGUtilsFitMode
